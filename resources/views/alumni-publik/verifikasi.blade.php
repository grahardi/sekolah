...
<title>Data Alumni - Verifikasi</title>
...
.btn-primary { width:100%; background:#16a34a; color:#fff; border:none; padding:12px; border-radius:8px; font-size:14px; font-weight:600; cursor:pointer; }
</style>
</head>
<body>
<div class="card">
    <div style="text-align:center;margin-bottom:22px;">
        ...
        <p style="font-size:13px;color:#64748b;margin:6px 0 0;">Ceritakan ke sekolah, sekarang kamu lanjut kemana?</p>
    </div>
    ...
    <form action="{{ route('alumni-publik.verifikasi.proses', $npsn) }}" method="POST">
        @csrf
        <div style="margin-bottom:14px;">
            <label class="form-label">No. Induk (NIS atau NISN) waktu sekolah dulu</label>
