...
@section('page-title', 'Export Data Siswa')
...
<div style="max-width:560px;margin:0 auto;">
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
        <a href="{{ route('siswa.export.excel', $query) }}" class="card export-choice" style="display:flex;align-items:center;gap:16px;padding:20px;text-decoration:none;transition:box-shadow .12s;">
        ...
        <a href="{{ route('siswa.export.pdf', $query) }}" class="card export-choice" style="display:flex;align-items:center;gap:16px;padding:20px;text-decoration:none;transition:box-shadow .12s;">
            ...
            <div>
                ...
                <p style="font-size:12px;color:#64748b;margin:0;">Daftar siswa siap cetak dalam format PDF (A4 landscape).</p>
            </div>
        </a>
    </div>
</div>
