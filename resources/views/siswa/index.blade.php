...
@section('header-actions')
    ...
    <a href="{{ route('siswa.export.excel', request()->query()) }}" class="btn btn-secondary">
        <i class="ti ti-table-export"></i> Excel
    </a>
    <a href="{{ route('siswa.export.pdf', request()->query()) }}" class="btn btn-secondary">
