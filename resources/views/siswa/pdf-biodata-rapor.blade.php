...
.foto-frame { width:120px; height:150px; border:1.5px solid #333; overflow:hidden; background-position:center top; background-repeat:no-repeat; background-size:cover; }
