...
<head>
    ...
    <title>@yield('title', 'Buku Alumni')</title>
...
<aside class="sidebar">
    <div class="sb-brand">
        <div class="sb-brand-icon"><i class="ti ti-school"></i></div>
        <div>
            <div class="sb-brand-name">sekolah.co.id</div>
            <div class="sb-brand-sub">Buku Alumni</div>
        </div>
    </div>
    ...
    <nav class="sb-nav">
        ...
        <div class="sb-section">Tambah Data</div>
        <a href="{{ route('alumni.create') }}"
           class="sb-item {{ request()->routeIs('alumni.create') ? 'active' : '' }}">
            <i class="ti ti-user-plus"></i><span>Tambah Manual</span>
        </a>
        <a href="{{ route('alumni.import-dapodik.form') }}"
           class="sb-item {{ request()->routeIs('alumni.import-dapodik.*') ? 'active' : '' }}">
            <i class="ti ti-file-import"></i><span>Import Dapodik</span>
        </a>
        <a href="{{ route('alumni.import-berkas.form') }}"
...
<div class="main-wrap">
    <header class="topbar">
        <div style="display:flex;align-items:center;">
            ...
            <span class="topbar-title">@yield('page-title','Buku Alumni')</span>
        </div>
