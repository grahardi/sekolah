...
<aside class="sidebar">
    <div class="sb-brand">
        <div class="sb-brand-icon"><i class="ti ti-building"></i></div>
        <div>
            <div class="sb-brand-name">sekolah.co.id</div>
            <div class="sb-brand-sub">Manajemen Sekolah</div>
        </div>
    </div>
    ...
    <nav class="sb-nav">
        ...
        <a href="{{ route('manajemen-sekolah.dashboard') }}"
           class="sb-item {{ request()->routeIs('manajemen-sekolah.dashboard') ? 'active' : '' }}">
            <i class="ti ti-layout-dashboard"></i><span>Dashboard</span>
        </a>

        <div class="sb-divider"></div>
        <div class="sb-section">Data</div>
        <a href="{{ route('manajemen-sekolah.data-siswa') }}"
           class="sb-item {{ request()->routeIs('manajemen-sekolah.data-siswa') ? 'active' : '' }}">
            <i class="ti ti-users"></i><span>Data Siswa</span>
        </a>
        <a href="{{ route('manajemen-sekolah.data-guru') }}"
           class="sb-item {{ request()->routeIs('manajemen-sekolah.data-guru') ? 'active' : '' }}">
            <i class="ti ti-user-check"></i><span>Data Guru</span>
        </a>
        ...
        <a href="{{ route('manajemen-sekolah.absensi.rekap') }}"
           class="sb-item {{ request()->routeIs('manajemen-sekolah.absensi.rekap') ? 'active' : '' }}">
            <i class="ti ti-report"></i><span>Rekap Bulanan</span>
        </a>

        <div class="sb-divider"></div>
        <div class="sb-section">Modul Lain</div>
        <div class="sb-item-demo" title="Segera hadir">
            <i class="ti ti-alert-octagon"></i><span>Tata Tertib</span><span class="sb-demo-badge">Segera</span>
        </div>
        <div class="sb-item-demo" title="Segera hadir">
            <i class="ti ti-notes"></i><span>Bimbingan Konseling</span><span class="sb-demo-badge">Segera</span>
        </div>
        <div class="sb-item-demo" title="Segera hadir">
            <i class="ti ti-spray"></i><span>Kebersihan Kelas</span><span class="sb-demo-badge">Segera</span>
        </div>
        <div class="sb-item-demo" title="Segera hadir">
            <i class="ti ti-door"></i><span>Peminjaman Ruang</span><span class="sb-demo-badge">Segera</span>
        </div>
    </nav>
...
<div class="main-wrap">
    <header class="topbar">
        <span class="topbar-title">@yield('page-title','Manajemen Sekolah')</span>
