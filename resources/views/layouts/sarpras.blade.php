...
<aside class="sidebar">
    <div class="sb-brand">
        <div class="sb-brand-icon"><i class="ti ti-building-warehouse"></i></div>
        <div>
            <div class="sb-brand-name">sekolah.co.id</div>
            <div class="sb-brand-sub">Sarpras</div>
        </div>
    </div>
    ...
    <nav class="sb-nav">
        ...
        <a href="{{ route('sarpras.assets.index') }}"
           class="sb-item {{ request()->routeIs('sarpras.assets.index') ? 'active' : '' }}">
        ...
        <a href="{{ route('sarpras.assets.index') }}"
           class="sb-item {{ request()->routeIs('sarpras.assets.*') ? 'active' : '' }}">
            <i class="ti ti-box"></i><span>Data Barang</span>
        </a>
        <a href="{{ route('sarpras.categories.index') }}"
...
<div class="main-wrap">
    <header class="topbar">
        <div style="display:flex;align-items:center;">
            ...
            <span class="topbar-title">@yield('page-title','Sarpras')</span>
        </div>
