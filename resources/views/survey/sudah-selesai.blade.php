...
<style>
    * { font-family:'Inter',sans-serif; box-sizing:border-box; }
    ...
    .icon { width:60px; height:60px; background:#fef3c7; border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 16px; font-size:28px; }
...
<body>
    <div class="box">
        ...
        <h1>Sudah Pernah Mengisi</h1>
        <p>Kamu sudah mengisi survey ini sebelumnya. Setiap siswa hanya bisa mengisi 1 kali.</p>
    </div>
</body>
</html>
