...
<div id="tab-mengajar" class="tab-pane">
    <div class="card" style="padding:30px;text-align:center;">
        <i class="ti ti-clipboard-list" style="font-size:36px;color:#2563EB;"></i>
        <p style="font-size:14px;font-weight:700;color:#0f172a;margin:12px 0 6px;">Kelola Tugas Mengajar di E-Rapor</p>
        <p style="font-size:13px;color:#64748b;margin:0 0 16px;">
            Assign mata pelajaran & kelas yang diampu {{ $pegawai->nama_lengkap }} lewat halaman
            khusus di modul E-Rapor - satu tempat yang sama dipakai untuk semua guru
            (termasuk guru bantu yang tidak terdaftar di Kepegawaian).
        </p>
        <a href="{{ route('erapor.tugas-mengajar.dari-pegawai', $pegawai) }}" class="btn btn-primary">
            <i class="ti ti-arrow-right"></i> Buka Tugas Mengajar di E-Rapor
        </a>
    </div>
</div>
