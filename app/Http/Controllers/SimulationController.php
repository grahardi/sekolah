...
class SimulationController extends Controller
{
    ...
    private const CATALOG = [
        ...
        'gerak-harmonik' => ['category' => 'Fisika', 'title' => 'Gerak Harmonik Sederhana', 'subject' => 'Getaran & Gelombang', 'desc' => 'Pegas dan massa yang berosilasi, amati hubungan simpangan, kecepatan, dan percepatan.'],
        'hukum-newton' => ['category' => 'Fisika', 'title' => 'Hukum Newton & Gaya', 'subject' => 'Mekanika', 'desc' => 'Terapkan gaya pada benda, lihat bagaimana massa mempengaruhi percepatan.'],
        'optik-lensa' => ['category' => 'Fisika', 'title' => 'Optik: Lensa & Cermin', 'subject' => 'Optik Geometri', 'desc' => 'Geser posisi benda, amati pembentukan bayangan pada lensa cembung/cekung.'],
        'gelombang-bunyi' => ['category' => 'Fisika', 'title' => 'Gelombang Bunyi', 'subject' => 'Getaran & Gelombang', 'desc' => 'Ubah frekuensi dan amplitudo, dengar dan lihat bentuk gelombang bunyi.'],
        'termodinamika-gas' => ['category' => 'Fisika', 'title' => 'Termodinamika Gas Ideal', 'subject' => 'Termodinamika', 'desc' => 'Ubah suhu dan volume, amati pergerakan partikel gas dan tekanan yang dihasilkan.'],
        'medan-magnet' => ['category' => 'Fisika', 'title' => 'Medan Magnet', 'subject' => 'Listrik & Magnet', 'desc' => 'Visualisasikan garis medan magnet di sekitar kawat berarus dan magnet batang.'],
        'tegangan-permukaan' => ['category' => 'Fisika', 'title' => 'Tegangan Permukaan & Fluida', 'subject' => 'Mekanika Fluida', 'desc' => 'Amati efek tegangan permukaan dan tekanan hidrostatis pada fluida.'],
