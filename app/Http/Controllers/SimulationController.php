...
class SimulationController extends Controller
{
    ...
    private const CATALOG = [
        ...
        // ---------------- BIOLOGI ----------------
        'struktur-sel' => ['category' => 'Biologi', 'title' => 'Struktur Sel Hewan & Tumbuhan', 'subject' => 'Biologi Sel', 'desc' => 'Jelajahi organel sel secara interaktif, bandingkan sel hewan dan tumbuhan.', 'component' => 'Simulations/CellStructure'],
        'peredaran-darah' => ['category' => 'Biologi', 'title' => 'Sistem Peredaran Darah', 'subject' => 'Anatomi Manusia', 'desc' => 'Ikuti aliran darah melalui jantung, arteri, dan vena secara animasi.', 'component' => 'Simulations/BloodCirculation'],
        'fotosintesis' => ['category' => 'Biologi', 'title' => 'Fotosintesis', 'subject' => 'Fisiologi Tumbuhan', 'desc' => 'Atur intensitas cahaya dan CO2, amati laju fotosintesis berubah.', 'component' => 'Simulations/Photosynthesis'],
        'sistem-pencernaan' => ['category' => 'Biologi', 'title' => 'Sistem Pencernaan Manusia', 'subject' => 'Anatomi Manusia', 'desc' => 'Telusuri jalur makanan dari mulut hingga usus, pelajari fungsi tiap organ.', 'component' => 'Simulations/DigestiveSystem'],
        'genetika-mendel' => ['category' => 'Biologi', 'title' => 'Genetika Persilangan (Hukum Mendel)', 'subject' => 'Genetika', 'desc' => 'Silangkan sifat induk, lihat rasio genotipe dan fenotipe keturunan.', 'component' => 'Simulations/MendelGenetics'],
        'ekosistem-rantai-makanan' => ['category' => 'Biologi', 'title' => 'Ekosistem & Rantai Makanan', 'subject' => 'Ekologi', 'desc' => 'Susun rantai makanan, amati dampak perubahan populasi salah satu spesies.', 'component' => 'Simulations/FoodChain'],
        'sistem-pernapasan' => ['category' => 'Biologi', 'title' => 'Sistem Pernapasan', 'subject' => 'Anatomi Manusia', 'desc' => 'Amati mekanisme inspirasi dan ekspirasi pada paru-paru manusia.', 'component' => 'Simulations/RespiratorySystem'],
        'struktur-dna' => ['category' => 'Biologi', 'title' => 'Struktur DNA', 'subject' => 'Genetika', 'desc' => 'Jelajahi struktur heliks ganda DNA dan pasangan basa nitrogen.', 'component' => 'Simulations/DnaStructure'],
        'siklus-air' => ['category' => 'Biologi', 'title' => 'Siklus Air', 'subject' => 'Ekologi', 'desc' => 'Ikuti tahap evaporasi, kondensasi, dan presipitasi dalam siklus air.', 'component' => 'Simulations/WaterCycle'],
        'evolusi-seleksi-alam' => ['category' => 'Biologi', 'title' => 'Evolusi & Seleksi Alam', 'subject' => 'Evolusi', 'desc' => 'Simulasikan seleksi alam pada populasi dengan variasi sifat tertentu.', 'component' => 'Simulations/NaturalSelection'],
        'sistem-saraf' => ['category' => 'Biologi', 'title' => 'Sistem Saraf Manusia', 'subject' => 'Anatomi Manusia', 'desc' => 'Amati impuls saraf merambat dari badan sel ke ujung akson.', 'component' => 'Simulations/NervousSystem'],
        'sistem-ekskresi' => ['category' => 'Biologi', 'title' => 'Sistem Ekskresi (Ginjal)', 'subject' => 'Anatomi Manusia', 'desc' => 'Pahami peran ginjal menyaring darah dan mengatur keseimbangan air tubuh.', 'component' => 'Simulations/ExcretorySystem'],
        'sistem-gerak' => ['category' => 'Biologi', 'title' => 'Sistem Gerak (Otot & Rangka)', 'subject' => 'Anatomi Manusia', 'desc' => 'Lihat bagaimana otot bisep-trisep menggerakkan tulang di sekitar sendi siku.', 'component' => 'Simulations/MuscularSkeletalSystem'],
        'reproduksi-manusia' => ['category' => 'Biologi', 'title' => 'Sistem Reproduksi Manusia', 'subject' => 'Anatomi Manusia', 'desc' => 'Jelajahi organ reproduksi laki-laki dan perempuan beserta fungsinya.', 'component' => 'Simulations/HumanReproduction'],
        'mikroorganisme' => ['category' => 'Biologi', 'title' => 'Dunia Mikroorganisme', 'subject' => 'Mikrobiologi', 'desc' => 'Amati kurva pertumbuhan bakteri dipengaruhi suhu dan nutrisi.', 'component' => 'Simulations/MicroorganismGrowth'],
        'bioteknologi-fermentasi' => ['category' => 'Biologi', 'title' => 'Bioteknologi Sederhana (Fermentasi)', 'subject' => 'Bioteknologi', 'desc' => 'Lihat proses fermentasi ragi menghasilkan gas CO2 dari gula.', 'component' => 'Simulations/Fermentation'],
        'adaptasi-kamuflase' => ['category' => 'Biologi', 'title' => 'Adaptasi Makhluk Hidup (Kamuflase)', 'subject' => 'Evolusi', 'desc' => 'Pahami bagaimana kemiripan warna dengan lingkungan meningkatkan peluang bertahan hidup.', 'component' => 'Simulations/Camouflage'],
        'pertumbuhan-tanaman' => ['category' => 'Biologi', 'title' => 'Pertumbuhan & Perkembangan Tanaman', 'subject' => 'Fisiologi Tumbuhan', 'desc' => 'Atur cahaya, air, dan nutrisi, amati pengaruhnya pada pertumbuhan tanaman.', 'component' => 'Simulations/PlantGrowth'],
        'siklus-karbon' => ['category' => 'Biologi', 'title' => 'Siklus Karbon & Oksigen', 'subject' => 'Ekologi', 'desc' => 'Amati dampak deforestasi terhadap keseimbangan CO2 di atmosfer.', 'component' => 'Simulations/CarbonCycle'],
        'sistem-kekebalan-tubuh' => ['category' => 'Biologi', 'title' => 'Sistem Kekebalan Tubuh (Imun)', 'subject' => 'Anatomi Manusia', 'desc' => 'Lihat antibodi mengejar dan menetralkan patogen dalam tubuh.', 'component' => 'Simulations/ImmuneSystem'],
    ];
