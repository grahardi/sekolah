...
class Sekolah extends Model
{
    ...
    protected $fillable = [
        ...
        'watermark_induk_aktif',
        'watermark_induk_teks',
        'watermark_induk_gambar',
        'watermark_induk_transparansi',
        'box_fill_induk',
        'box_font_induk',
        'box_font_size_induk',
        'desc_font_size_induk',
        'induk_ukuran_kertas',
        'watermark_biodata_aktif',
        'watermark_biodata_teks',
        'watermark_biodata_gambar',
        'watermark_biodata_transparansi',
        'box_fill_biodata',
        'box_font_biodata',
        'box_font_size_biodata',
        'desc_font_size_biodata',
        'biodata_ukuran_kertas',
    ...
    protected $casts = [
        'is_demo' => 'boolean',
        'watermark_induk_aktif' => 'boolean',
        'watermark_biodata_aktif' => 'boolean',
