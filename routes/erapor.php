...
Route::middleware(['web', 'auth'])->prefix('erapor')->name('erapor.')->group(function () {
    ...
    Route::middleware(['admin_or_induk', 'block_write_for_induk'])->group(function () {
        ...
        Route::get('/guru/duplikat', [EraporController::class, 'guruDuplikatIndex'])->name('guru.duplikat');
        Route::post('/guru/duplikat/gabung', [EraporController::class, 'guruDuplikatGabung'])->name('guru.duplikat-gabung');
